...
export default function Topbar({ onNew }: { onNew: () => void }) {
  return (
    <header className="flex items-center justify-between gap-4 p-4 border-b border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900">
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-2 bg-white/70 dark:bg-slate-800/60 px-3 py-1 rounded-md shadow-sm">
          <button className="text-sm px-3 py-1 rounded-md bg-blue-600 text-white" onClick={onNew}>New task</button>
